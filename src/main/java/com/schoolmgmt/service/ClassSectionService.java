...
//        Integer maxId = schoolClassRepository.findMaxClassIdentifierForTenant(tenantId);
//
...
//        if (schoolClassRepository.exaistsByTenantIdAndNameIgnoreCase(tenantId, request.getName())) {
...
//        Integer maxSuffix = schoolClassRepository.findMaxClassIdentifierForTenant(tenantId);
...
//            String classIdentifier = tenantId + String.format("%02d", sequence++);
//
...
//                .capacity(section.getCapacity())
//                .schoolClassId(section.getSchoolClassId())
//                .schoolClassCode(schoolClass.getClassIdentifier())
//                .schoolClassName(schoolClass.getName())
//                .classTeacherId(section.getClassTeacher() != null ? section.getClassTeacher().getId() : null)
//                .classTeacherName(section.getClassTeacher() != null ?
//                    section.getClassTeacher().getFirstName() + " " + section.getClassTeacher().getLastName() : null)
...
//
//        SchoolClass schoolClass = schoolClassRepository.findById(updated.getSchoolClassId())
//                .orElseThrow(() -> new RuntimeException("Class not found"));
//
...
//        }
//
//        SchoolClass schoolClass = schoolClassRepository.findById(section.getSchoolClassId())
//                .orElseThrow(() -> new RuntimeException("Class not found"));
//
//        // Delete section

...
import com.schoolmgmt.domain.student.Student;
import com.schoolmgmt.domain.student.StudentRepository;
import com.schoolmgmt.domain.user.User;
import com.schoolmgmt.domain.user.UserRepository;
import com.schoolmgmt.infrastructure.exception.BusinessException;
import com.schoolmgmt.infrastructure.exception.ResourceNotFoundException;
import com.schoolmgmt.infrastructure.multitenancy.TenantContext;
import com.schoolmgmt.presentation.dto.StudentDto.*;
...
public class StudentService {
    ...
    public StudentResponse createStudent(CreateStudentRequest request) {
        ...
        Student student = Student.builder()
                ...
                .currentSectionId(request.getCurrentSectionId())
